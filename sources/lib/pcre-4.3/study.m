...
static void
set_bit(uschar *start_bits, int c, BOOLE caseless, compile_data *cd)
{
...
static BOOLE
set_start_bits(const uschar *code, uschar *start_bits, BOOLE caseless,
  BOOLE utf8, compile_data *cd)
{
register int c;
