...
typedef struct match_data {
  ...
  const uschar *lcc;            /* Points to lower casing table */
  const uschar *ctypes;         /* Points to table of type maps */
  BOOLE   offset_overflow;       /* Set if too many extractions */
  BOOLE   notbol;                /* NOTBOL flag */
  BOOLE   noteol;                /* NOTEOL flag */
  BOOLE   utf8;                  /* UTF8 flag */
  BOOLE   endonly;               /* Dollar not before final \n */
  BOOLE   notempty;              /* Empty string match not wanted */
