...
//
// $Id: MCPResult.h 33 2005-03-13 01:39:05Z glennsb $
// $Author: sergecohen $
...
@protected
   MYSQL_RES           *mResult;	/*"The MYSQL_RES structure of the C API"*/
    ...
    unsigned long       mVersion; /* version of the server that produced this result */
}
/*"
Class maintenance
"*/
...
- (id) initWithResPtr:(MYSQL_RES *) mySQLResPtr 
             encoding:(NSStringEncoding) theEncoding
        serverVersion:(unsigned long) theVersion;
- (id) init;
